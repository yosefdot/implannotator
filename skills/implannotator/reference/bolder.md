...
**WARNING - AI SLOP TRAP**: Review ALL the DON'T guidelines from the parent implannotator skill (already loaded in this context) before proceeding. Bold means distinctive, not "more effects."
...
When the result feels right, hand off to `$implannotator polish` for the final pass.
