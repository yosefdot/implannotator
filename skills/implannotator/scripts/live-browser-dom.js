/**
 * Browser-side DOM helpers for Implannotator live mode.
 *
...
(function (root) {
  ...
  function createLiveBrowserDomHelpers({
    ...
    function makeFrozenAnchor(el) {
      ...
      return {
        __implannotatorFrozenAnchor: true,
    ...
    function liveUiRoot() {
      const uiRoot = root.__IMPLANNOTATOR_LIVE_UI_ROOT__;
  ...
  root.__IMPLANNOTATOR_LIVE_DOM__ = {
    version: 1,
