 ...
 *     serializes LIVE_COMMANDS into window.__IMPLANNOTATOR_VOCAB__ alongside the
...
export const LIVE_COMMANDS = [
  { value: 'implannotator', label: 'Freeform',  icon: `<svg ${ICON_ATTRS}><path d="M4 20l4-1L18 9l-3-3L5 16z"/><path d="M14 7l3 3"/></svg>` },
