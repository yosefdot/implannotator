/**
 * Framework-neutral Implannotator live chrome contract.
 *
...
export const LIVE_UI_SURFACES = Object.freeze([
  {
    ...
    ids: [
      'implannotator-live-global-bar',
      'implannotator-live-global-bar-brand',
      'implannotator-live-pick-toggle',
      'implannotator-live-insert-toggle',
      'implannotator-live-detect-toggle',
      'implannotator-live-detect-badge',
      'implannotator-live-design-toggle',
      'implannotator-live-page-chat',
      'implannotator-live-page-chat-input',
      'implannotator-live-page-chat-voice',
    ],
    states: ['rest', 'hover', 'focus-visible', 'pressed', 'active', 'tooltip'],
  },
  {
    key: 'pending-copy-edit-dock',
    ids: ['implannotator-live-pending-dock'],
    states: ['closed', 'open', 'hover', 'pressed', 'loading', 'rollback', 'keep-fixing'],
  },
  {
    key: 'element-selection-chrome',
    ids: [
      'implannotator-live-highlight',
      'implannotator-live-tooltip',
      'implannotator-live-bar',
      'implannotator-live-selection-pill',
      'implannotator-live-input',
      'implannotator-live-configure-voice',
      'implannotator-live-configure-bar-tooltip',
    ],
    states: ['rest', 'hover', 'focus-visible', 'pressed', 'disabled'],
  },
  {
    key: 'action-picker',
    ids: ['implannotator-live-picker'],
    states: ['closed', 'open', 'option-hover', 'option-focus'],
  },
  {
    key: 'edit-chrome',
    ids: ['implannotator-live-edit-badge'],
    states: ['enabled', 'disabled', 'editing', 'cancel', 'save', 'edited-content'],
  },
  {
    key: 'generating-row',
    ids: ['implannotator-live-bar', 'implannotator-live-shader'],
    states: ['action-label', 'animated-dots', 'generating', 'done'],
  },
  {
    key: 'variant-cycling-row',
    ids: ['implannotator-live-bar', 'implannotator-live-params-panel'],
    states: ['variant-1', 'variant-2', 'variant-3', 'left-disabled', 'right-disabled', 'dot-click', 'accept', 'discard'],
  },
  {
    key: 'variant-params-panel',
    ids: ['implannotator-live-params-panel'],
    states: ['closed', 'open-above', 'open-below', 'range', 'steps', 'toggle'],
  },
  {
    key: 'saving-confirmed-rows',
    ids: ['implannotator-live-bar'],
    states: ['saving', 'applying-variant', 'confirmed'],
  },
  {
    key: 'insert-mode-chrome',
    ids: [
      'implannotator-live-insert-line',
      'implannotator-live-insert-placeholder',
      'implannotator-live-placeholder-resize',
      'implannotator-live-insert-input',
      'implannotator-live-insert-voice',
      'implannotator-live-insert-create',
      'implannotator-live-insert-create-tooltip',
    ],
  ...
  },
  {
    ...
    ids: [
      'implannotator-live-annot',
      'implannotator-live-annot-svg',
      'implannotator-live-annot-pins',
      'implannotator-live-annot-clear',
    ],
    states: ['overlay', 'drawing', 'pin', 'pin-edit', 'clear'],
  },
  {
    key: 'design-system-panel',
    ids: ['implannotator-live-design-host'],
    states: ['closed', 'open', 'tabs', 'token-tiles', 'copy'],
  },
  {
    key: 'toasts-and-errors',
    ids: ['implannotator-live-toast'],
    states: ['normal', 'error', 'no-variants-mounted'],
  },
  {
    key: 'css-isolation-boundary',
    ids: ['implannotator-live-root'],
...
export function resolveLiveUiRoot(env = globalThis) {
  ...
  const explicit = env?.__IMPLANNOTATOR_LIVE_UI_ROOT__
    || env?.window?.__IMPLANNOTATOR_LIVE_UI_ROOT__;
...
export function appendToLiveUiRoot(el, env = globalThis) {
  const root = resolveLiveUiRoot(env);
  if (!root) throw new Error('Implannotator live UI root is not available');
  root.appendChild(el);
  return el;
}
