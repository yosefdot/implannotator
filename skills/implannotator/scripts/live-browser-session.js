/**
 * Browser-side durable session helpers for Implannotator live mode.
 *
 ...
 * window.__IMPLANNOTATOR_LIVE_SESSION__.
 */
(function (root) {
  'use strict';
  ...
  root.__IMPLANNOTATOR_LIVE_SESSION__ = { createLiveBrowserSessionState };
