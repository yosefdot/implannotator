...
} from '../../lib/implannotator-config.mjs';
import {
  HTML_EXTENSIONS,
  buildImportGraph,
...
function printUsage() {
  console.log(`Usage: implannotator detect [options] [file-or-dir-or-url...]
...
Options:
  ...
  --no-design-system  Do not load local DESIGN.md / .implannotator/design.json context
  --help              Show this help message

Project config:
  Respects .implannotator/config.json and .implannotator/config.local.json detector
...
Examples:
  implannotator detect src/
  implannotator detect index.html
  implannotator detect https://example.com
  implannotator detect --json .
  implannotator detect --no-config src/`);
}
            ...
            if (fwConfig) {
              ...
              if (probe.listening && probe.matched) {
                process.stderr.write(
                  ...
                  `  npx implannotator detect http://localhost:${fwConfig.port}\n\n`
                );
