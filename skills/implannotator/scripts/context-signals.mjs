#!/usr/bin/env node
/**
 * Context-signals gatherer for the bare `{{command_prefix}}implannotator`
 ...
 * light: no LLM calls, no detector run (`npx implannotator detect` is heavier and
 ...
 *   - critique:  the latest cached critique score (.implannotator/critique)
